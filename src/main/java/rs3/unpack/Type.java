...
public enum Type {
    ...
    PLAYER_GROUP_INVITE_RESULT(120, 'Å', BaseVarType.INTEGER),
    PLAYER_GROUP_MODIFY_RESULT(121, 'Ë', BaseVarType.INTEGER),
    PLAYER_GROUP_JOIN_OR_CREATE_RESULT(122, 'Í', BaseVarType.INTEGER),
    PLAYER_GROUP_AFFINITY_MODIFY_RESULT(123, 'Õ', BaseVarType.INTEGER),
    PLAYER_GROUP_DELTA_TYPE(124, '²', BaseVarType.INTEGER),
    ...
    TYPE_137(137, '‹', BaseVarType.INTEGER), // 928
    TYPE_138(138, '/', BaseVarType.INTEGER), // 928
    // === 928 end ==
    // === 929 end ==
    // === 930 end ==
    // === 932 end ==
    ...
    public static boolean subtype(Type a, Type b) {
        ...
        if (b == UNKNOWN_LONG) {
            return a.baseType == BaseVarType.LONG;
        }
