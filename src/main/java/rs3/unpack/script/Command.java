...
public class Command {
    ...
    public static final Command FLOW_ARRAY_UPDATE_ADD = defineCommand("flow_array_update_add"); // $arr(...) += ...
    public static final Command FLOW_ARRAY_UPDATE_SUB = defineCommand("flow_array_update_sub"); // $arr(...) -= ...
    public static final Command FLOW_ARRAY_UPDATE_MULTIPLY = defineCommand("flow_array_update_multiply"); // $arr(...) *= ...
    public static final Command FLOW_ARRAY_UPDATE_DIVIDE = defineCommand("flow_array_update_divide"); // $arr(...) /= ...
    public static final Command FLOW_ARRAY_UPDATE_MODULO = defineCommand("flow_array_update_modulo"); // $arr(...) %= ...
